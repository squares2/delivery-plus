    ...
    const STEPS = [
        {
            ...
            body: 'مطاعم، سوبرماركت، ملاحم، أفران، حلويات، كافيهات — كل شي بمكان واحد. رتّبة حسب الأكثر طلباً لتوصلك للأفضل بسرعة.',
            tags: ['🍔 مطاعم', '🛒 سوبرماركت', '🥩 ملاحم', '🍰 حلويات', '☕ كافيه'],
            img: delivoImg('assets/hero-mobile1.webp'),
            color: '#FF5C00',
        },
        {
            icon: `<svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            img: delivoImg('assets/hero-mobile2.webp'),
            color: '#e05500',
        },
        {
            icon: `<svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            img: delivoImg('assets/hero-mobile3.webp'),
            color: '#cc4800',
        },
        {
            icon: `<svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            img: delivoImg('assets/hero-mobile4.webp'),
            color: '#FF5C00',
        },
    ];
