...
function renderStores() {
    ...
    stores.forEach(([name, s]) => {
        ...
        const imgPicture = `<picture style="width:100%;height:100%;display:block;"><source srcset="${delivoImg(`assets/${imgSlug}.webp`)}" type="image/webp"><img src="${delivoImg(`assets/${imgSlug}.png`)}" alt="${_escAttr(name)}" style="width:100%;height:100%;object-fit:cover;" onerror="this.closest('picture').style.display='none';this.closest('picture').nextElementSibling.style.display='flex'"></picture>`;
